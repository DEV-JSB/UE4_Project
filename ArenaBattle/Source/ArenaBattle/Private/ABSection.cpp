...
AABSection::AABSection()
{
	...
	static FName GeteSockets[] = { {TEXT("+XGate")}, {TEXT("-XGate")},{TEXT("+YGate")},{TEXT("-YGate")} };

	for (FName GateSocket : GeteSockets)
	{
...
void AABSection::OnConstruction(const FTransform& Transform)
{
	...
	SetState(bNoBattle ? ESectionState::COMPOLETE : ESectionState::READY);
}
...
void AABSection::SetState(ESectionState NewState)
{
	...
	case AABSection::ESectionState::BATTLE:
		...
		break;
	case AABSection::ESectionState::COMPOLETE:
		Trigger->SetCollisionProfileName(TEXT("NoCollision"));
		for (UBoxComponent* GateTrigger : GateTriggers)
		{
...
void AABSection::OnTriggerBeginOverlap(UPrimitiveComponent* OverlappedComponent, AActor* OtherActor, UPrimitiveComponent* OhterComp, int32 OtherBodyIndex, bool bFromsweep, const FHitResult& SweepResult)
{
...
void AABSection::OnGateTriggerBeginOverlap(UPrimitiveComponent* OverlappedComponent, AActor* OtherActor, UPrimitiveComponent* OhterActor, int32 OhterBodyIndex, bool bFromSweep, const FHitResult& SweepResult)
{
...
void AABSection::OnKeyNPCDestroyed(AActor* DestroyedActor)
{
	...
	SetState(ESectionState::COMPOLETE);
}
