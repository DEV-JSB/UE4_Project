...
void UABHUDWidget::BindCharacterStat(class UABCharacterStatComponent* CharacterStat)
{
	...
	CharacterStat->OnHPChanged.AddUObject(this, &UABHUDWidget::UpdateCharacterState);
}
void UABHUDWidget::BindPlayerState(AABPlayerState* PlayerState)
{
	ABCHECK(nullptr != PlayerState);
	CurrentPlayerState = PlayerState;
	PlayerState->OnPlayerStateChanged.AddUObject(this, &UABHUDWidget::UpdateCharacterState);
...
void UABHUDWidget::NativeConstruct()
{
	...
	HPBar = Cast<UProgressBar>(GetWidgetFromName(TEXT("phHP")));
...
void UABHUDWidget::UpdateCharacterState()
{
...
void UABHUDWidget::UdpatePlayerState()
{
}
