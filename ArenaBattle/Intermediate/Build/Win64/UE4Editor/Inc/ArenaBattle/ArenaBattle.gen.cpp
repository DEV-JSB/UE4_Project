...
// End Cross Module References
	...
	uint32 Get_Z_Construct_UEnum_ArenaBattle_ECharacterState_Hash() { return 2813973880U; }
	UEnum* Z_Construct_UEnum_ArenaBattle_ECharacterState()
	{
		...
		if (!ReturnEnum)
		{
			static const UE4CodeGen_Private::FEnumeratorParam Enumerators[] = {
				{ "ECharacterState::PRENINIT", (int64)ECharacterState::PRENINIT },
			...
			const UE4CodeGen_Private::FMetaDataPairParam Enum_MetaDataParams[] = {
				...
				{ "PRENINIT.Name", "ECharacterState::PRENINIT" },
